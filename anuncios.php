    ...
    <div class="contenedor-anuncio">
      ...
      <div class="anuncio">
        <picture>
          ...
          <img src="build/img/anuncio4.jpg" alt="anuncio2" loading="lazy" />
        </picture>
        <div class="contenido-anuncio">
          <h3>Casa Terminada de Lujo</h3>
          <p>
      ...
      <div class="anuncio">
        <picture>
          ...
          <img src="build/img/anuncio5.jpg" alt="anuncio2" loading="lazy" />
        </picture>
        <div class="contenido-anuncio">
          <h3>Casa Terminada de Lujo</h3>
          <p>
      ...
      <div class="anuncio">
        <picture>
          ...
          <img src="build/img/anuncio6.jpg" alt="anuncio2" loading="lazy" />
        </picture>
        <div class="contenido-anuncio">
          <h3>Casa Terminada de Lujo</h3>
          <p>
